...
namespace General.CLS
{
    ...
    class Materias
    {
        ...
        public Boolean Insertar()
        {
            ...
            try
            {
                Sentencia = @"INSERT INTO materias(materia) VALUES('" + _Materia + "');";
        ...
        public Boolean Actualizar()
        {
            ...
            try
            {
                ...
                Sentencia = @"UPDATE materias SET materia='" + _Materia + "' " +
        ...
        public Boolean Eliminar()
        {
            ...
            try
            {
                Sentencia = @"DELETE FROM materias WHERE idmateria=" + _IDMateria + ";";
                DataManager.DBOperacion Operacion = new DataManager.DBOperacion();
